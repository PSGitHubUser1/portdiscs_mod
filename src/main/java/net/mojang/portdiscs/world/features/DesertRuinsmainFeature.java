...
public class DesertRuinsmainFeature extends Feature<NoneFeatureConfiguration> {
	...
	public static final Predicate<BiomeSelectionContext> GENERATE_BIOMES = BiomeSelectors.includeByKey(ResourceKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("desert")),
	...
	public DesertRuinsmainFeature() {
		...
		base_blocks = List.of(Blocks.SANDSTONE, Blocks.SAND);
	}
