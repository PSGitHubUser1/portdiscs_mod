...
public class PortdiscsModEntities {
	...
	public static void load() {
		SOUL_SEEKER = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(PortdiscsMod.MODID, "soul_seeker"),
				FabricEntityTypeBuilder.create(MobCategory.MONSTER, SoulSeekerEntity::new)
						.dimensions(new EntityDimensions(0.6f, 1.9000000000000001f, true)).fireImmune().trackRangeBlocks(60)
		...
		SOULFISH = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(PortdiscsMod.MODID, "soulfish"),
				FabricEntityTypeBuilder.create(MobCategory.MONSTER, SoulfishEntity::new).dimensions(new EntityDimensions(0.4f, 0.3f, true))
						.trackRangeBlocks(16).forceTrackedVelocityUpdates(true).trackedUpdateRate(3).build());
		SoulfishEntity.init();
		FabricDefaultAttributeRegistry.register(SOULFISH, SoulfishEntity.createAttributes());
		STAFF_OF_TRAPPED_SOULS = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(PortdiscsMod.MODID, "staff_of_trapped_souls"),
				createArrowEntityType(StaffOfTrappedSoulsEntity::new));
		LEAVE_SHOOTER = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(PortdiscsMod.MODID, "leave_shooter"),
				createArrowEntityType(LeaveShooterEntity::new));
		STAFF_MINION = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(PortdiscsMod.MODID, "staff_minion"),
				FabricEntityTypeBuilder.create(MobCategory.MONSTER, StaffMinionEntity::new).dimensions(new EntityDimensions(0.4f, 0.3f, true))
						.trackRangeBlocks(32).forceTrackedVelocityUpdates(true).trackedUpdateRate(3).build());
