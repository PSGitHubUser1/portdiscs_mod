...
public class PortdiscsModItems {
	...
	public static Item SOUL_SEEKER;
	public static Item SOUL_SEEKER_HEAD;
	public static Item SOULFISH;
	...
	public static void load() {
		...
		CITRINEBLOCK = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "citrineblock"),
				new BlockItem(PortdiscsModBlocks.CITRINEBLOCK, new Item.Properties().tab(PortdiscsModTabs.TAB_INFOYS_PORTDISCS_MOD)));
		CITRINEORE = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "citrineore"),
				new BlockItem(PortdiscsModBlocks.CITRINEORE, new Item.Properties().tab(PortdiscsModTabs.TAB_INFOYS_PORTDISCS_MOD)));
		COMET_TENM = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "comet_tenm"), new CometTenmItem());
		COMPRESSED_CITRINE = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "compressed_citrine"),
				new BlockItem(PortdiscsModBlocks.COMPRESSED_CITRINE, new Item.Properties().tab(PortdiscsModTabs.TAB_INFOYS_PORTDISCS_MOD)));
		...
		NOTHERN_LIGHTS_TENM = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "nothern_lights_tenm"),
				new NothernLightsTenmItem());
		...
		SOUL_SEEKER = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "soul_seeker_spawn_egg"), new SpawnEggItem(
				PortdiscsModEntities.SOUL_SEEKER, -14869219, -16745626, new Item.Properties().tab(PortdiscsModTabs.TAB_INFOYS_PORTDISCS_MOD)));
		SOUL_SEEKER_HEAD = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "soul_seeker_head"),
				new BlockItem(PortdiscsModBlocks.SOUL_SEEKER_HEAD, new Item.Properties().tab(PortdiscsModTabs.TAB_INFOYS_PORTDISCS_MOD)));
		SOULFISH = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "soulfish_spawn_egg"), new SpawnEggItem(
				PortdiscsModEntities.SOULFISH, -13423563, -16736610, new Item.Properties().tab(PortdiscsModTabs.TAB_INFOYS_PORTDISCS_MOD)));
		SOULLESS_TENM = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "soulless_tenm"), new SoullessTenmItem());
		STAFF_OF_DARK_WOODS = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "staff_of_dark_woods"),
				new StaffOfDarkWoodsItem());
		STAFF_OF_TRAPPED_SOULS = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "staff_of_trapped_souls"),
				new StaffOfTrappedSoulsItem());
		STRIDE_TENM = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "stride_tenm"), new StrideItem());
		THE_ENDER_DRAGON_TENM = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "the_ender_dragon_tenm"),
				new TheEnderDragonTenmItem());
		...
		MUSIC_BOX = Registry.register(Registry.ITEM, new ResourceLocation(PortdiscsMod.MODID, "music_box"),
				new BlockItem(PortdiscsModBlocks.MUSIC_BOX, new Item.Properties().tab(null)));
