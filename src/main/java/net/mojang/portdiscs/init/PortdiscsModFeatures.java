...
public class PortdiscsModFeatures {
	public static void load() {
		...
		register("miners_hideout", MinersHideoutmainFeature.feature(), MinersHideoutmainFeature.GENERATE_BIOMES,
				GenerationStep.Decoration.UNDERGROUND_STRUCTURES);
		register("pillager_station", PillagerStationmainFeature.feature(), PillagerStationmainFeature.GENERATE_BIOMES,
		...
		register("golden_heart", GoldenHeartmainFeature.feature(), GoldenHeartmainFeature.GENERATE_BIOMES,
				GenerationStep.Decoration.UNDERGROUND_STRUCTURES);
		register("desert_ruins", DesertRuinsmainFeature.feature(), DesertRuinsmainFeature.GENERATE_BIOMES,
				GenerationStep.Decoration.SURFACE_STRUCTURES);
		register("mysterious_egg", MysteriousEggmainFeature.feature(), MysteriousEggmainFeature.GENERATE_BIOMES,
				GenerationStep.Decoration.SURFACE_STRUCTURES);
		...
		register("overgrown_dungeon", OvergrownDungeonmainFeature.feature(), OvergrownDungeonmainFeature.GENERATE_BIOMES,
				GenerationStep.Decoration.UNDERGROUND_STRUCTURES);
	...
	private static void register(String registryName, Feature feature, Predicate<BiomeSelectionContext> biomes, GenerationStep.Decoration genStep) {
		...
		BiomeModifications.addFeature(biomes, genStep,
				ResourceKey.create(Registry.PLACED_FEATURE_REGISTRY, new ResourceLocation(PortdiscsMod.MODID, registryName)));
	}
}
